    ...
    def _runtime_for(self, turn: dict[str, object]) -> AgenticTurnRuntime:
        ...
        try:
            session = TurnSession(
                ...
                limits=AgenticLimits(deadline=TURN_DEADLINE, max_iterations=configured_limits["max_iterations"], max_actions=None if configured_limits["max_iterations"] is None else 24, max_output_tokens=4096, max_context_tokens=60_000),
