...
class ConversationApplication(Protocol):
    ...
    def create(self, context: object, *, message: str, provider: str, model_id: str, workspace_id: str | None, idempotency_key: str, project_id: str | None = None, attachments: object = (), new_conversation_id: str | None = None, code_mode: str = "auto") -> object: ...
    def send(self, user_id: str, conversation_id: str, message: str, idempotency_key: str, attachments: object = (), provider: str = "", model_id: str = "", code_mode: str = "auto") -> object: ...
