...
- [x] **Step 1: Write fixtures and public test helpers**
...
- [x] **Step 2: Write one failing test for each valid transition**
...
- [x] **Step 3: Write failing tests for rejected behavior**
...
- [x] **Step 4: Write failing tests for concurrency, idempotency, and required outcomes**
...
- [x] **Step 5: Run the tests and verify the expected RED state**
...
- [x] **Step 1: Define opaque ID aliases and exact enums**
...
- [x] **Step 2: Define validated immutable values**
...
- [x] **Step 3: Define the event envelope and outbox entry**
...
- [x] **Step 1: Define the required command context**
...
- [x] **Step 2: Define command types for lifecycle operations**
...
- [x] **Step 3: Define atomic transaction contracts**
...
- [x] **Step 1: Encode the RFC 102 transition table as data**
...
- [x] **Step 2: Build one transaction for every accepted mutation**
...
- [x] **Step 3: Implement command idempotency and result mapping**
...
- [x] **Step 4: Implement atomic in-memory persistence**
...
- [x] **Step 1: Add minimal configuration**
...
- [x] **Step 3: Inspect scope and forbidden imports**
...
- [x] **Step 4: Perform RFC self-review**
...
All implementation steps above are supported by the existing execution tests plus closeout regressions. The in-memory persistence is a test adapter only; distributed leases and PostgreSQL durability remain outside this plan. The closeout additionally scopes idempotency by full execution ownership and validates forged transaction context, audit identity and state/outbox correspondence before the adapter mutates. The historical commit step is not evidence of this closeout; no commit was created in the current working tree.
