...
- [x] **Step 3: Implement minimal immutable shared contracts**
...
- [x] **Step 1: Write failing descriptor and immutability tests**
...
- [x] **Step 3: Implement the public catalog value objects**
...
- [x] **Step 3: Implement the minimal in-memory catalog**
...
- [x] **Step 3: Implement the resolution pipeline**
...
- [x] **Step 1: Write failing Provider API tests**
...
- [x] **Step 3: Implement public Provider contracts and validator**
...
- [x] **Step 3: Implement adapters and preserve Runtime behavior**
...
- [x] **Step 4: Run integration and regression tests and verify GREEN**
...
- [x] **Step 3: Scan Provider boundaries**
...
- [x] **Step 4: Audit the requirements explicitly**
...
Capture the fresh exit codes and counts from the complete pytest, compileall and boundary scan commands. Do not claim completion unless all required commands have fresh successful evidence. The workspace is a Git repository; commit/push is an integration decision outside this closeout.

## Kernel closeout note (2026-08-06)

All implementation steps above are supported by the Providers suite and closeout regressions. Profile preferences, purpose constraints, actual cost ceilings, accumulated fallback cost, catalog idempotency scope, model binding, image/tool approval and approved response-format revalidation are enforced. A materialized policy source for `FallbackMode.POLICY` is not present and is therefore explicitly rejected/documented; no implicit candidate discovery was added. Concrete Provider adapters, SDKs, credentials and network remain outside scope.
